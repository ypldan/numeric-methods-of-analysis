...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        HashMap<Integer,float[][]> tables=new HashMap<>();
        HashMap<Integer,ArrayList<Float>> nodeLists=new HashMap<>();
        HashMap<Integer, NewtonPolynom> polynoms=new HashMap<>();
        m.forEach(x -> {
            ArrayList<Float> nodes=chebyshevNodes(0,10,x,f);
